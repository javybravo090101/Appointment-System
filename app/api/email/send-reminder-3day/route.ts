...
export async function POST(request: Request) {
  try {
    ...
    if (!appt || appt.reminder_3day_sent) {
    ...
    await sendEmail({
      ...
      htmlContent: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #4f9d69;">Appointment Reminder — 3 Days</h2>
          <p>Hi ${clientName},</p>
          <p>This is a reminder that your appointment is coming up in <strong>3 days</strong>.</p>
    ...
    console.error("send-reminder-3day error:", err);
