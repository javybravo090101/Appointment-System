...
export async function POST(request: Request) {
  try {
    ...
    await sendEmail({
      ...
      htmlContent: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #4f9d69;">Appointment Approved</h2>
          <p>Hi ${clientName},</p>
    ...
    await supabase.from("notifications").insert({
      ...
      message: `Your ${appt.services?.name} appointment on ${appt.appointment_date} has been approved.`,
    });
